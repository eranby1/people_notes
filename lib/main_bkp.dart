  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          // כפתור לצפייה/עריכה של פרטי האיש קשר
          IconButton(
